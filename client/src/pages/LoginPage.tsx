        ...
        <Card className="w-full max-w-md border-none shadow-2xl rounded-[2.5rem] overflow-hidden">
          <CardContent className="p-8 md:p-12">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500">Entrez votre numéro de téléphone pour vous connecter</p>
            </div>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input type="tel" placeholder="0812345678" value={phone} onChange={(e) => setPhone(formatPhone(e.target.value))}
                    className="pl-12 h-14 rounded-xl text-lg font-medium" data-testid="input-phone" autoFocus />
                </div>
              </div>
              <Button type="submit" disabled={isLoading || phone.length < 9}
                className="w-full h-14 rounded-xl bg-secondary hover:bg-secondary/90 text-white font-bold text-base gap-2" data-testid="button-login">
