...
(async () => {
  ...
  // Allow overriding the bind host via the HOST env var. This is useful for
  // deploy platforms (e.g. Replit) where the app must bind to 0.0.0.0 so the
  // external proxy can reach it. Fallback to 127.0.0.1 for local development.
